...
try {
  ...
  summary = {
    ...
    readOnlyAdapterContractStatus: "not-evaluated",
    disabledAdapterDraftStatus: "not-evaluated",
...
const checklist = {
  ...
  readOnlyAdapterContractStatus: summary.readOnlyAdapterContractStatus || "not-evaluated",
  disabledAdapterDraftStatus: summary.disabledAdapterDraftStatus || "not-evaluated",
