...
const checklist = {
  ...
  operatorChecks: [
    "確認 reviewed-local-agent-health.json 由 operator 本地生成。",
    "確認檔案已去敏，不含 API key、token、cookie、secret、Authorization。",
    "確認 expectedAgentCount = 1。",
    "確認 agents.length = 1。",
    "確認 source 是 local-reviewed-json 或 local-file-only。",
    "若狀態為 unknown/stale/review-required，只可走人工 runbook。",
    "不可在 Dashboard restart / stop / start agent。",
    "不可連 production gateway。",
