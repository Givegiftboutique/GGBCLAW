...
const checklist = {
  ...
  dailyChecks: [
    "開 Dashboard 要見到 Operator Home / Operator 首頁。",
  ...
  warningSigns: [
    ...
    "如果 source badge 顯示 mock，請改開 recommended operator URL。",
    "如果 source badge 顯示 gateway-stub，這是 contract fixture。",
    "如果 health unknown / stale，請看 runbook，不要 restart。",
    "如果 evidence fallback，請檢查 reviewed JSON。",
    "Production no-go 是正常狀態，不代表 local dashboard 壞了。"
  ],
  doNotDo: [
